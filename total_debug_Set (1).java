...
/*---------------------------------------------------------------------------------------------------*/	
	...
	public Block resetMRU(int address){
    	...
    	for(int i =old_pos ; i>0 ; i--){
			...
			System.out.println("resetMRU_1");
			System.out.println(i-1+ " address : " + Integer.toHexString(theseBlocks[i-1].getAddress()) );
			System.out.println(i-1+" dirty   : " + theseBlocks[i-1].isDirty());
			
			theseBlocks[i] = theseBlocks[i-1];
		
				//Temp Debug statements
			System.out.println("resetMRU_2");
			System.out.println(i+ " address : " + Integer.toHexString(theseBlocks[i].getAddress()) );
			System.out.println(i+" dirty   : " + theseBlocks[i].isDirty());
    	}
		theseBlocks[0] = moving_block; //put reset Block in MRU
		
		//Temp Debug statements
		System.out.println("MRU address : " + Integer.toHexString(theseBlocks[0].getAddress()) );
		System.out.println("MRU dirty   : " + theseBlocks[0].isDirty());
...
/*---------------------------------------------------------------------------------------------------*/		
	...
	public Block removeLRU(){
    	...
    	for(int i =setASSOC-1 ; i>0 ; i--){
    						...
    						//Temp Debug statements
			System.out.println("removeLRU_1");						
			System.out.println(i-1+ " address : " + Integer.toHexString(theseBlocks[i-1].getAddress()) );
			System.out.println(i-1+" dirty   : " + theseBlocks[i-1].isDirty());
			...
			theseBlocks[i] = theseBlocks[i-1];
					...
					//Temp Debug statements
			System.out.println("removeLRU_2");						
			System.out.println(i+ " address : " + Integer.toHexString(theseBlocks[i].getAddress()) );
			System.out.println(i+" dirty   : " + theseBlocks[i].isDirty());
    	}
...
/*---------------------------------------------------------------------------------------------------*/
	...
	public void incNonFull(){
    	...
    	for(int i = (setASSOC-1) ; i>0 ; i--){
    			...
    			//Temp Debug statements
			System.out.println("incNonFull_1");						
			System.out.println(i-1+ " address : " + Integer.toHexString(theseBlocks[i-1].getAddress()) );
			System.out.println(i-1+" dirty   : " + theseBlocks[i-1].isDirty());
			...
			theseBlocks[i] = theseBlocks[i-1];
					...
					//Temp Debug statements
			System.out.println("incNonFull_2");						
			System.out.println(i+ " address : " + Integer.toHexString(theseBlocks[i].getAddress()) );
			System.out.println(i+" dirty   : " + theseBlocks[i].isDirty());
    	}
		theseBlocks[0] = empty; //MRU spot invalid, ready for incomeing block
